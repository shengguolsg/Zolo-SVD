...
*
*     ===================
      SUBROUTINE MPDORGQR( M, N, K, A, IA, JA, DESCA, TAU, WORK, LWORK,
     $                    INFO )
*
...
*  =======
*
*  MPDORGQR generates an M-by-N real distributed matrix Q denoting
...
*        Q  =  H(1) H(2) . . . H(k)
*
*  as returned by MPDGEQRF. Note that M = 2*N and A is originally A=[B; I] 
*  a tall skinny matrix. This routine is designed for the QDWH algorithm for
...
*          of the distributed submatrix Q. M = 2N.
*
...
*
     ...
     $   RETURN
*
*     JL is the beginning column of the last block
*     JN is the blocksize, NB or K if K < NB
*
...
*
*     Set the top JL-1 entries of the last block of columns of A to be zero
...
*
            CALL PDORG2R( MT-I+IA, JB, JB, A, I, J, DESCA, TAU, WORK,
     $                    LWORK, IINFO )
*
...
*
     ...
     $                 MT, N-JB, JB, A, IA, JA, DESCA, WORK, A, IA,
     $                 JA+JB, DESCA, WORK( IPW ) )
*
*        Apply H to rows ia:ia+m-1 of current block
*
         CALL PDORG2R( MT, JB, JB, A, IA, JA, DESCA, TAU, WORK, LWORK,
     $                 IINFO )
*
      END IF
*
