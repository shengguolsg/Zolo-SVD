!
    SUBROUTINE PZOLOPD1( SYM,RK,M,N,ALPHA,BETA,As,IA,JA,DESCA,Q,IQ,JQ,DESCQ,INFO,POLAR )
!
      use auxil_zolo
...
! 
! This routine is rewritten from test_zolosvdf1.f90, and it is aimed for
! optimizing it. 
! 
! 
!  Notes
...
!       Each group compute the Cholesky factorization independently. 
     ...
     !IF(myid ==0 ) write(*,*) 'FCON', FCON, 'FONE',FONE, FCON/FONE
     ...
     ttt2 = MPI_Wtime() 
     IF(myid ==0 ) write(*,*) 'FormX2 costs', ttt2-ttt1, ERR
